@extends('layouts/detail_pesanan_qris')
@section('content')
    <div class="app-wrapper">
        ...
        <div class="content">
            ...
            <div class="section">
                ...
                <!-- Payment Thumbnail dengan teks -->
                <div class="payment-thumbnail-card" onclick="openImageModal()">
                    <div class="payment-thumbnail">
                        <img src="qris.jpg" alt="Bukti Pembayaran">
                    </div>
                    <span class="payment-filename">pembayaran.png</span>
                </div>
            </div>
    ...
    <!-- Modal Gambar Bukti Pembayaran (Klik X untuk tutup) -->
    <div class="modal-overlay" id="imageModal" style="display: none;">
        <div class="modal-content" onclick="event.stopPropagation()">
            <button class="modal-close-btn" onclick="closeImageModal()" style="position: absolute; top: 15px; right: 15px; background: white; border: none; border-radius: 50%; width: 35px; height: 35px; cursor: pointer; font-size: 20px; color: #5a1a1a; display: flex; align-items: center; justify-content: center; z-index: 10;">×</button>
            <img class="modal-image" src="qris.jpg" alt="Bukti Pembayaran BCA">
            <p style="text-align: center; margin-top: 15px; color: #666; font-size: 14px;">Klik di luar atau tombol X untuk menutup</p>
        </div>
    </div>

    <!-- Modal Success (Muncul setelah klik Proses -> Selesai) -->
...
@push('scripts')
    ...
    // Tutup modal gambar jika klik di luar konten
